...
const reportTypes = [
  { name: 'RIM Report', icon: FileCheck, href: '/rim', description: 'Resurvey and Index Map - cadastral section with parcels, beacons and ownership', color: 'text-blue-500 bg-blue-500/10' },
