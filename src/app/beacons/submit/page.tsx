  ...
  return (
    <div className="min-h-screen bg-gray-950 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-100 mb-2">Submit a Beacon</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm text-gray-400 mb-2">Beacon Name *</label>
                <input
                  type="text"
                  required
                  value={form.name}
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">Beacon Type *</label>
                <select
            ...
            <div className="mt-4">
              <label className="block text-sm text-gray-400 mb-2">Authority / Organization</label>
              <select
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-4">
              <div>
                <label className="block text-sm text-gray-400 mb-2">Elevation (m)</label>
                <input
                  type="number"
                  step="0.001"
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-2">UTM Zone</label>
                <select
                  value={form.utmZone}
