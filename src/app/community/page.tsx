  ...
  const features = [
    {
      ...
      description: 'Buy, sell and rent survey equipment',
      links: [
        { label: 'Browse Equipment', href: '/marketplace' },
        { label: 'List Equipment', href: '/marketplace?action=list' }
      ],
      color: 'bg-blue-500'
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-xl p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Link href="/marketplace" className="p-4 border rounded-lg hover:bg-[var(--bg-secondary)] transition">
              <Search className="w-5 h-5 text-blue-500 mb-2" />
              <p className="font-medium">Equipment Marketplace</p>
              <p className="text-sm text-[var(--text-muted)]">Buy, sell & rent equipment</p>
            </Link>
