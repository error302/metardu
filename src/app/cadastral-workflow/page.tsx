...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'Upload your surveyed boundary polygon and validate it against the registry data. Check for overlaps, gaps, and area discrepancies before proceeding to beacon placement.',
    href: '/cadastra',
    cta: 'Validate boundary',
    reference: 'Survey Act Cap 299 § 22 · boundary determination',
    hints: [
