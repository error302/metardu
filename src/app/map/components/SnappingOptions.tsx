...
export function SnappingOptions({
  ...
  return (
    <div className="absolute top-14 right-3 z-30 w-72 bg-[#0d0d14]/95 backdrop-blur-2xl border border-white/[0.08] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-right-2 duration-200">
      {/* Header */}
