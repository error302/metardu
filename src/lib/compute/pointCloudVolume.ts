...
export function gridMethodVolume(
  ...
  // ⚡ Bolt Optimization: Use getBounds which uses a single O(N) loop
  // instead of spreading large arrays which can cause V8 Maximum Call Stack Size Exceeded errors.
